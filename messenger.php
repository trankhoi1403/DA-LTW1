			...
			<div class="row justify-content-center h-100">
					...
					<div class="card-body contacts_body">
						...
						<li class="active">
							<div class="d-flex bd-highlight">
								<div class="img_cont">
									<img src="<?php echo $getUser['avatar'] ?>" class="rounded-circle user_img">
				...
				<div class="col-md-8 col-xl-6 chat">
					<div class="card">
						...
						<div class="card-body msg_card_body" id="chatContent">
							<div class="d-flex justify-content-start mb-4">
								<div class="img_cont_msg">
									<img src="<?php echo $getUser['avatar'] ?>" class="rounded-circle user_img_msg">
								</div>
							...
							<div class="d-flex justify-content-end mb-4">
								...
								<div class="img_cont_msg">
									<img src="<?php echo $currentUser['avatar'] ?>" class="rounded-circle user_img_msg">
								</div>
							</div>
						</div>
